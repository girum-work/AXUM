"""
AXUM ROVER — YOLOv8 Coin Detail Training
=========================================
...
Run: python scripts/train_yolov8_coins.py
"""
...
def main() -> None:
    """Train YOLOv8 nano on Ethiopian coin subtypes."""
    print("=" * 60)
    print("YOLOV8 — ETHIOPIAN COIN DETAIL")
    print("=" * 60)
    ...
    try:
        ...
        best = Path("models/yolov8_coins/weights/best.pt")
        if best.exists():
