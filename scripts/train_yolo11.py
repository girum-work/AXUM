"""
AXUM ROVER — YOLO11 Fine-Tuning
=================================
Fine-tunes YOLO11 nano on your artefact images.
...
Run: python scripts/train_yolo11.py
"""
...
SAVE_PATH   = Path("models/yolo11_artefacts.pt")
TRAIN_SPLIT = 0.85
EPOCHS      = 50
IMG_SIZE    = 224

print("="*60)
print("YOLO11 NANO FINE-TUNING")
print("="*60)
...
try:
    ...
    results = model.train(
        ...
        patience    = 10,
        project     = "models",
        name        = "yolo11_artefacts",
        exist_ok    = True,
        verbose     = True
    )
    best = Path("models/yolo11_artefacts/weights/best.pt")
    if best.exists():
        shutil.copy(best, SAVE_PATH)
        print(f"\n✓ YOLO11 model saved: {SAVE_PATH}")
except ImportError:
